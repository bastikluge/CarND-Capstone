...
class DBWNode(object):
    ...
    def loop(self):
        rate = rospy.Rate(50) # 50Hz (change to lower value for simulation if required - there seems to be some growing lag between controller and simulator)
    ...
    # Callback for twist messages published on /current_velocity
    # TwistStamped:
    #   Header header
    #     ...
    #   Twist twist
    ...
    def dbw_enabled_cb(self, msg):
        if msg.data != self.dbw_enabled:
            rospy.loginfo('DBWNode sets dbw_enabled = %s', msg.data)
